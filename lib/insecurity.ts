...
import * as z85 from './z85'
import { UserModel, IAuthenticatedUsers, ResponseWithUser } from './types'
...
export const hmac = (data: string) => crypto.createHmac('sha256', process.env.HMAC_KEY ?? '').update(data).digest('hex')
